...
{
    /// <summary> A Class representing a KeyValue along with the instance operations that can be performed on it. </summary>
    public partial class KeyValue : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="KeyValue"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="KeyValue"/> class for mocking. </summary>
        protected KeyValue()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "KeyValue"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal KeyValue(ArmClient client, KeyValueData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal KeyValue(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _keyValueClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppConfiguration", ResourceType.Namespace, DiagnosticOptions);
        ...
        public async virtual Task<Response<KeyValue>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _keyValueClientDiagnostics.CreateScope("KeyValue.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new KeyValue(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<KeyValue> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _keyValueClientDiagnostics.CreateScope("KeyValue.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _keyValueClientDiagnostics.CreateScope("KeyValue.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<KeyValue>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));

            using var scope = _keyValueClientDiagnostics.CreateScope("KeyValue.AddTag");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new KeyValue(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<KeyValue> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
        ...
        public async virtual Task<Response<KeyValue>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));

            using var scope = _keyValueClientDiagnostics.CreateScope("KeyValue.SetTags");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<KeyValue> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));
        ...
        public async virtual Task<Response<KeyValue>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));

            using var scope = _keyValueClientDiagnostics.CreateScope("KeyValue.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<KeyValue> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
