...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    internal partial class SubscriptionExtensionClient : ArmResource
    {
        ...
        {
            return new DeletedConfigurationStoreCollection(Client, Id);
        }
        ...
        public virtual AsyncPageable<DeletedConfigurationStore> GetDeletedConfigurationStoresAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<DeletedConfigurationStore>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new DeletedConfigurationStore(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
