...
namespace Azure.ResourceManager.AppConfiguration
{
    ...
    public partial class KeyValueCollection : ArmCollection, IEnumerable<KeyValue>, IAsyncEnumerable<KeyValue>
    {
        ...
        internal KeyValueCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            TryGetApiVersion(KeyValue.ResourceType, out string keyValueApiVersion);
        ...
        public async virtual Task<ArmOperation<KeyValue>> CreateOrUpdateAsync(bool waitForCompletion, string keyValueName, KeyValueData keyValueParameters = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppConfigurationArmOperation<KeyValue>(Response.FromValue(new KeyValue(Client, response), response.GetRawResponse()));
        ...
        /// <exception cref="ArgumentException"> <paramref name="keyValueName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="keyValueName"/> is null. </exception>
        public virtual ArmOperation<KeyValue> CreateOrUpdate(bool waitForCompletion, string keyValueName, KeyValueData keyValueParameters = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(keyValueName, nameof(keyValueName));
        ...
        public virtual AsyncPageable<KeyValue> GetAllAsync(string skipToken = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<KeyValue>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new KeyValue(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
